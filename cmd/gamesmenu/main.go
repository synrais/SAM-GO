...
// Main menu
// -------------------------
func mainMenu(cfg *config.UserConfig, stdscr *gc.Window, files []gamesdb.GobEntry) error {
...
// Loader
// -------------------------
func loadingWindow(stdscr *gc.Window, loadFn func() ([]gamesdb.GobEntry, error)) ([]gamesdb.GobEntry, error) {
	status := struct {
		Done   bool
		Error  error
		Result []gamesdb.GobEntry
	}{}
