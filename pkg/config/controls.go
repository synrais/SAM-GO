...
// Controls
//
// The games menu's shortcuts are fixed: Y (tab) = Search, X (space) =
...
// using the names the input test (gamesmenu.sh -inputs) prints.
...
// splitList turns "esc, Backspace" into ["esc", "backspace"].
