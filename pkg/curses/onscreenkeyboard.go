...
func OnScreenKeyboard(stdscr *gc.Window, title string, buttons []string, defaultText string, defaultButton int) (int, string, error) {
	return OnScreenKeyboardWith(stdscr, title, buttons, defaultText, defaultButton, KeyboardOpts{})
}

// OnScreenKeyboardWith is OnScreenKeyboard with extra options. It returns
// the pressed button, or -1 for Esc.
func OnScreenKeyboardWith(stdscr *gc.Window, title string, buttons []string, defaultText string, defaultButton int, opts KeyboardOpts) (int, string, error) {
