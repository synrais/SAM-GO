...
func copySetnameBios(cfg *config.Config, origSystem System, newSystem System, name string) error {
	var biosPath string
...
func hookFDS(cfg *config.Config, system System, _ string) (string, error) {
...
func hookWSC(cfg *config.Config, system System, _ string) (string, error) {
...
func hookAo486(_ *config.Config, system System, path string) (string, error) {
...
func hookAmiga(_ *config.Config, system System, path string) (string, error) {
...
func hookNeoGeo(_ *config.Config, _ System, path string) (string, error) {
...
var systemHooks = map[string]func(*config.Config, System, string) (string, error){
	"FDS":             hookFDS,
...
func RunSystemHook(cfg *config.Config, system System, path string) (string, error) {
